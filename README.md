...
Development on the Master branch is for the latest version of [TensorRT 8.2.1.4](https://developer.nvidia.com/nvidia-tensorrt-download) with full-dimensions and dynamic shape support.
...
### Dependencies
 ...
 - [TensorRT 8.2.1.4](https://developer.nvidia.com/tensorrt)
 - [TensorRT 8.2.1.4 open source libaries (master branch)](https://github.com/NVIDIA/TensorRT/)
...
TensorRT 8.2.1.4 supports ONNX release 1.8.0. Install it with:
